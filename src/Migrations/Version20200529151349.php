 ...
 */
final class Version20200529151349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE structure (id INT AUTO_INCREMENT NOT NULL, complete_name VARCHAR(255) NOT NULL, usual_name VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, logo VARCHAR(255) DEFAULT NULL, structure_type VARCHAR(255) NOT NULL, website VARCHAR(255) NOT NULL, external_payment_link VARCHAR(255) DEFAULT NULL, legal_represent_first_name VARCHAR(255) NOT NULL, legal_represent_last_name VARCHAR(255) NOT NULL, legal_represent_mail VARCHAR(255) NOT NULL, legal_represent_role VARCHAR(255) NOT NULL, office_mail VARCHAR(255) NOT NULL, office_phone INT NOT NULL, office_address VARCHAR(255) NOT NULL, territory_office VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE authorization (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_7A6D8BEF67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, phone INT NOT NULL, city VARCHAR(255) NOT NULL, zip_code INT NOT NULL, address VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE children (id INT AUTO_INCREMENT NOT NULL, age INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE authorization ADD CONSTRAINT FK_7A6D8BEF67B3B43D FOREIGN KEY (users_id) REFERENCES users (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE authorization DROP FOREIGN KEY FK_7A6D8BEF67B3B43D');
